The PBPK model for isoniazid was developed and verified with clinical pharmacokinetic data.
...
1. the final model input parameters for the building blocks: [Section 3.1](#final-input-parameters).
